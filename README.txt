...
-----------------------------------------------------
OPENCL VS CUDA VS TENSORRT VS EIGEN VS METAL VS ROCM:
-----------------------------------------------------
...
ROCm - Specific to top-end AMD GPU, and all the technical setup work just like CUDA configurations. Only support Linux at this moment.
