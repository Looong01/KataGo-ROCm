...
- [KataGo](#katago)
  ...
  - [Setting Up and Running KataGo](#setting-up-and-running-katago)
    ...
    - [MacOS](#macos)
    - [OpenCL vs CUDA vs TensorRT vs Eigen vs ONNX vs WinML](#opencl-vs-cuda-vs-tensorrt-vs-eigen-vs-onnx-vs-winml)
...
### OpenCL vs CUDA vs TensorRT vs Eigen vs ONNX vs WinML
KataGo has six backends, OpenCL (GPU), CUDA (GPU), TensorRT (GPU), Eigen (CPU), ONNX (CPU/GPU/NPU via providers), and WinML (Windows App SDK, GPU/NPU via EP catalog).
