...
* `neuralnet` - Neural net GPU implementation and interface. Contains OpenCL, CUDA, TensorRT, Metal, Eigen, ONNX, and WinML backends along with common interfaces and model data structures.
  ...
  * `{cuda,opencl,eigen,trt,metal,onnx,winml,dummy}backend.cpp` - Various backends.
