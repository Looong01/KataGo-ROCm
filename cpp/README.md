...
* `neuralnet` - Neural net GPU implementation and interface. Contains OpenCL, CUDA, Eigen, TensorRT, ROCm, ONNX, Metal, and WinML backends along with common interfaces and model data structures.
